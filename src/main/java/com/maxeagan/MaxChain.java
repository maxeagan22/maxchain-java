...
public class MaxChain {
    ...
    public static void main (String[] args) {
        ...
        // Create genesis transaction, which sends 100 MaxCoins to walletA
        genesisTransaction = new Transaction(coinbase.publicKey, walletA.publicKey, 100f, null);
        genesisTransaction.generateSignature(coinbase.privateKey);
        genesisTransaction.transactionId = "0"; // Set id to 0 since it is first transaction.

        // Store first transaction in the UTXOs list.
        ...
        System.out.println("\nWalletA Attempting to send more funds than it has...");
